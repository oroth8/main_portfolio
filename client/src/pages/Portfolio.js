                ...
                <div className="centered-container w-container">
                    ...
                    <div className="cards-grid-container">
                        <div id="w-node-84ac4a2cc32b-358a15f7">
                            ...
                            <p className="card-paragraph">A MERN stack social media application. Create a developer profile, post, comment, and like. A Facebook clone for developers.</p>
                        </div>
                        <div id="w-node-84ac4a2cc332-358a15f7">
                            ...
                            <p id="w-node-84ac4a2cc337-358a15f7" className="card-paragraph">An example of another custom, personal portfolio website created using react. Uses frame-motion animations and styled components. </p>
                        </div>
                        <div id="w-node-84ac4a2cc339-358a15f7">
                            ...
                            <p id="w-node-84ac4a2cc33e-358a15f7" className="card-paragraph">An e-commerce site that utilizes SQL and handlebars engine. This site is similar to amazon and has a admin dashboard.</p>
                        </div>
                    </div>
                    <div className="cards-grid-container">
                        <div id="w-node-d38d16c32e04-358a15f7">
                            ...
                            <p className="card-paragraph">Find Github accounts, view repos, and see other Github information in one, convenient application. MERN Stack. </p>
                        </div>
                        <div id="w-node-d38d16c32e0b-358a15f7">
                            ...
                            <p id="w-node-d38d16c32e10-358a15f7" className="card-paragraph">An educational MERN stack game create for the final project of my Northwestern University course. Uses custom built API, JSON Webtoken, and bcryptJS for encryption.</p>
                        </div>
                        <div id="w-node-d38d16c32e12-358a15f7">
                            ...
                            <p id="w-node-d38d16c32e17-358a15f7" className="card-paragraph">A MERN stack application that uses various technologies and dynamic elements to store/create contacts. </p>
                        </div>
                    </div>
                </div>
