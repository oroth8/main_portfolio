        ...
        <div className="body-3">
            ...
            <section id="cards-section" className="cards-section">
                <div className="centered-container w-container">
                    ...
                    <p className="project-paragraph">This is a collection of various projects I have personally made or contributed to. The projects listed below are featured projects chose by me. A full list of my projects and more information about them can be seen on my Github page. Feel free to contact me about any questions, issues, or contribution requests.
                    </p>
                    <div className="cards-grid-container">
                        <div id="w-node-84ac4a2cc32b-358a15f7">
                            ...
                            <p className="card-paragraph">A MERN stack social media application. Create a developer profile, post, comment, and like. A Facebook clone for developers.
                        ...
                        <div id="w-node-84ac4a2cc332-358a15f7">
                            ...
                            <p id="w-node-84ac4a2cc337-358a15f7" className="card-paragraph">An example of another custom, personal portfolio website created using react. Uses frame-motion animations and styled components.
                            <span className='project-icons'>
                                    <a href="!#">
                                        <i className="fab fa-github"></i>
                                    </a>
                        ...
                        <div id="w-node-84ac4a2cc339-358a15f7">
                            ...
                            <p id="w-node-84ac4a2cc33e-358a15f7" className="card-paragraph">An e-commerce site that utilizes SQL and handlebars engine. This site is similar to amazon and has a admin dashboard.
                            <span className='project-icons'>
                                    <a href="!#">
                                        <i className="fab fa-github"></i>
                                    </a>
                    ...
                    <div className="cards-grid-container">
                        <div id="w-node-d38d16c32e04-358a15f7">
                            ...
                            <p className="card-paragraph">Find Github accounts, view repos, and see other Github information in one, convenient application. MERN Stack.
                            <br />
                                <span className='project-icons'>
                                    <a href="!#">
                                        <i id="gf-icon" className="fab fa-github"></i>
                                    </a>
                                    <a href="!#">
                                        <i className="fas fa-external-link-alt"></i>
                                    </a>
                        ...
                        <div id="w-node-d38d16c32e0b-358a15f7">
                            ...
                            <p id="w-node-d38d16c32e10-358a15f7" className="card-paragraph">An educational MERN stack game create for the final project of my Northwestern University course. Uses custom built API, JSON Webtoken, and bcryptJS for encryption.
                            <span className='project-icons'>
                                    <a href="!#">
                                        <i className="fab fa-github"></i>
                                    </a>
                        ...
                        <div id="w-node-d38d16c32e12-358a15f7">
                            ...
                            <p id="w-node-d38d16c32e17-358a15f7" className="card-paragraph">A MERN stack application that uses various technologies and dynamic elements to store/create contacts.
                            <br />
                                <span className='project-icons'>
                                    <a href="!#">
                                        <i id="ck-icon" className="fab fa-github"></i>
                                    </a>
                                    <a href="!#">
                                        <i className="fas fa-external-link-alt"></i>
                                    </a>
